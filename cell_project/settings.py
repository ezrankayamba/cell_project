...
SECRET_KEY = 'bd$%beir&4!mi&eu&iql1-uyk-vu9&dho93&ml82uf1b@5&5on'
...
ROOT_URLCONF = 'cell_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'base.context_processors.add_log_entries',
            ],
        },
    },
]

WSGI_APPLICATION = 'cell_project.wsgi.application'
